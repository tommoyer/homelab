...
| `assets[].asset_id` | `string` | `yes` | `yes` | `liam-xbox` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `liam-xbox` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.1.10` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
