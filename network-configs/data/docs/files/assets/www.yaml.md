...
| `assets[].asset_id` | `string` | `yes` | `yes` | `www` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `www` | Hostname for the asset. |  |
