...
| `assets[].asset_id` | `string` | `yes` | `yes` | `liam-chromebook` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `liam-chromebook` | Hostname for the asset. |  |
...
| `assets[].interfaces[].if_id` | `string` | `yes` | `yes` | `hivemind` | Stable interface identifier within the asset. |  |
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.1.11` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
| `assets[].interfaces[].vlan_id` | `string` | `yes` | `yes` | `hivemind` | VLAN where this interface lives. |  |
