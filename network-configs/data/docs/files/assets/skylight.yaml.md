...
| `assets[].asset_id` | `string` | `yes` | `yes` | `skylight` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `skylight` | Hostname for the asset. |  |
