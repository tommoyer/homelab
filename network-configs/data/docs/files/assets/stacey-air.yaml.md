...
| `assets[].asset_id` | `string` | `yes` | `yes` | `stacey-air` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `stacey-air` | Hostname for the asset. |  |
