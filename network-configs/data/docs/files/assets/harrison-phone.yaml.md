...
| `assets[].asset_id` | `string` | `yes` | `yes` | `harrison-phone` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `harrison-phone` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.1.14` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
