...
| `assets[].asset_id` | `string` | `yes` | `yes` | `main-bedroom-tv` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `main-bedroom-tv` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `dynamic` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
