...
| `assets[].asset_id` | `string` | `yes` | `yes` | `stacey-mbp` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `stacey-mbp` | Hostname for the asset. |  |
