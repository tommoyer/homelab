...
| `assets[].asset_id` | `string` | `yes` | `yes` | `clean-air-2` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `clean-air-2` | Hostname for the asset. |  |
