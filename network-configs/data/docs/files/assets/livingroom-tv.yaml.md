...
| `assets[].asset_id` | `string` | `yes` | `yes` | `livingroom-tv` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `livingroom-tv` | Hostname for the asset. |  |
