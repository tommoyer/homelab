...
| `assets[].asset_id` | `string` | `yes` | `yes` | `color-printer` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `color-printer` | Hostname for the asset. |  |
