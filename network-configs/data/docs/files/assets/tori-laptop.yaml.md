...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tori-laptop` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tori-laptop` | Hostname for the asset. |  |
