...
| `assets[].asset_id` | `string` | `yes` | `yes` | `meer8-2-plug` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `meer8-2-plug` | Hostname for the asset. |  |
