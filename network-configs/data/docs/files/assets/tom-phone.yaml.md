...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tom-phone` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tom-phone` | Hostname for the asset. |  |
