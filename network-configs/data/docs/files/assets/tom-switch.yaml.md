...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tom-switch` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tom-switch` | Hostname for the asset. |  |
