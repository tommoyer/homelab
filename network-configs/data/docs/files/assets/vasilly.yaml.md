...
| `assets[].asset_id` | `string` | `yes` | `yes` | `vasilly` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `vasilly` | Hostname for the asset. |  |
