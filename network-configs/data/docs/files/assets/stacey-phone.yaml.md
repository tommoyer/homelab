...
| `assets[].asset_id` | `string` | `yes` | `yes` | `stacey-phone` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `stacey-phone` | Hostname for the asset. |  |
