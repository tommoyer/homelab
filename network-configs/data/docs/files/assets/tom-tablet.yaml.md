...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tom-tablet` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tom-tablet` | Hostname for the asset. |  |
