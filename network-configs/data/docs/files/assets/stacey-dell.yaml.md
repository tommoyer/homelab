...
| `assets[].asset_id` | `string` | `yes` | `yes` | `stacey-dell` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `stacey-dell` | Hostname for the asset. |  |
