...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tw-sync` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tw-sync` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.10.21` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
