...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tom-watch` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tom-watch` | Hostname for the asset. |  |
