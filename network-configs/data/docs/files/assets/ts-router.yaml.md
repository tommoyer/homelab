...
| `assets[].asset_id` | `string` | `yes` | `yes` | `ts-router` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `ts-router` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.10.23` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
