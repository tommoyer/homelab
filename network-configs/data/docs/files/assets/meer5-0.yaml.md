...
| `assets[].asset_id` | `string` | `yes` | `yes` | `meer5-0` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `meer5-0` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.10.2` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
