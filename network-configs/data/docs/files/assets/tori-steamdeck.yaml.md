...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tori-steamdeck` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tori-steamdeck` | Hostname for the asset. |  |
