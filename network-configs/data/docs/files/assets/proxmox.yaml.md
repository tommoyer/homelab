...
| `assets[].asset_id` | `string` | `yes` | `yes` | `proxmox` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `proxmox` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.10.29` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
