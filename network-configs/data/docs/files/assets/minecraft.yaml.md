...
| `assets[].asset_id` | `string` | `yes` | `yes` | `minecraft` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `minecraft` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.10.10` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
