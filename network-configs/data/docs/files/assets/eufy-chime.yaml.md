...
| `assets[].asset_id` | `string` | `yes` | `yes` | `eufy-chime` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `eufy-chime` | Hostname for the asset. |  |
