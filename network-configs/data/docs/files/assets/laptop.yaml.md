...
| `assets[].asset_id` | `string` | `yes` | `yes` | `laptop` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `laptop` | Hostname for the asset. |  |
