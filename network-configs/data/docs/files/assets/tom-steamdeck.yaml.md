...
| `assets[].asset_id` | `string` | `yes` | `yes` | `tom-steamdeck` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `tom-steamdeck` | Hostname for the asset. |  |
