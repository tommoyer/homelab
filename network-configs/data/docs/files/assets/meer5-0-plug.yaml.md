...
| `assets[].asset_id` | `string` | `yes` | `yes` | `meer5-0-plug` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `meer5-0-plug` | Hostname for the asset. |  |
