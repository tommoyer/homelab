...
| `assets[].asset_id` | `string` | `yes` | `yes` | `proxy` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `proxy` | Hostname for the asset. |  |
...
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.20.3` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
