...
| `assets[].asset_id` | `string` | `yes` | `yes` | `stacey-watch` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `stacey-watch` | Hostname for the asset. |  |
