...
| `assets[].asset_id` | `string` | `yes` | `yes` | `pihole-dmz` | Stable identifier for the asset; used by services and DNS names. |  |
| `assets[].hostname` | `string` | `yes` | `yes` | `pihole-dmz` | Hostname for the asset. |  |
...
| `assets[].interfaces[].if_id` | `string` | `yes` | `yes` | `dmz` | Stable interface identifier within the asset. |  |
| `assets[].interfaces[].ip` | `string` | `yes` | `yes` | `192.168.20.2` | IP address for the interface or 'dynamic' if DHCP/reserved elsewhere. |  |
| `assets[].interfaces[].vlan_id` | `string` | `yes` | `yes` | `dmz` | VLAN where this interface lives. |  |
