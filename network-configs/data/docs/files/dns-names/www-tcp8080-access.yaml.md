# dns-names/www-tcp8080-access.yaml
## Purpose
...
| `dns_names[].dns_id` | `string` | `yes` | `yes` | `www-tcp8080-access` | Stable identifier for the DNS record object. |  |
...
| `dns_names[].fqdn` | `string` | `yes` | `yes` | `www.thomasmoyer.org` | Fully qualified domain name to publish. |  |
...
| `dns_names[].targets.service_id` | `string` | `yes` | `yes` | `www-tcp8080` | Service target (mutually exclusive with asset_id). |  |
