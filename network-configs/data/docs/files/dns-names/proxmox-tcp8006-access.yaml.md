# dns-names/proxmox-tcp8006-access.yaml
## Purpose
...
| `dns_names[].dns_id` | `string` | `yes` | `yes` | `proxmox-tcp8006-access` | Stable identifier for the DNS record object. |  |
...
| `dns_names[].fqdn` | `string` | `yes` | `yes` | `proxmox.moyer.wtf` | Fully qualified domain name to publish. |  |
...
| `dns_names[].targets.service_id` | `string` | `yes` | `yes` | `proxmox-tcp8006` | Service target (mutually exclusive with asset_id). |  |
