# dns-names/kuma-tcp3001-access.yaml
## Purpose
...
| `dns_names[].dns_id` | `string` | `yes` | `yes` | `kuma-tcp3001-access` | Stable identifier for the DNS record object. |  |
...
| `dns_names[].fqdn` | `string` | `yes` | `yes` | `kuma.moyer.wtf` | Fully qualified domain name to publish. |  |
...
| `dns_names[].targets.service_id` | `string` | `yes` | `yes` | `kuma-tcp3001` | Service target (mutually exclusive with asset_id). |  |
