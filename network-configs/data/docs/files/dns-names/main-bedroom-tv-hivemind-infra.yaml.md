# dns-names/main-bedroom-tv-hivemind-infra.yaml
## Purpose
...
## Objects
- `main-bedroom-tv-hivemind-infra`
...
| `dns_names[].dns_id` | `string` | `yes` | `yes` | `main-bedroom-tv-hivemind-infra` | Stable identifier for the DNS record object. |  |
...
| `dns_names[].fqdn` | `string` | `yes` | `yes` | `main-bedroom-tv.hivemind.moyer.wtf` | Fully qualified domain name to publish. |  |
...
| `dns_names[].targets.asset_id` | `string` | `yes` | `yes` | `main-bedroom-tv` | Asset target (mutually exclusive with service_id). |  |
