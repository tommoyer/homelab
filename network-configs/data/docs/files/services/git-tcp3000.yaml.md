...
| `services[].asset_id` | `string` | `yes` | `yes` | `git` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Gitea` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `git-tcp3000` | Stable identifier for the service; often includes port/protocol. |  |
