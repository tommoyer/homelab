...
| `services[].asset_id` | `string` | `yes` | `yes` | `www` | Asset where this service runs. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `www-tcp8080` | Stable identifier for the service; often includes port/protocol. |  |
