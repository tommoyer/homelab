...
| `services[].asset_id` | `string` | `yes` | `yes` | `grafana` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Grafana` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `grafana-tcp3000` | Stable identifier for the service; often includes port/protocol. |  |
