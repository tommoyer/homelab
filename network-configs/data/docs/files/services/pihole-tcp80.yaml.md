...
| `services[].asset_id` | `string` | `yes` | `yes` | `pihole` | Asset where this service runs. |  |
...
| `services[].interface_id` | `string` | `yes` | `yes` | `hivemind` | Which interface on the asset should be used for backend addressing. |  |
| `services[].name` | `string` | `yes` | `yes` | `PiHole` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `pihole-tcp80` | Stable identifier for the service; often includes port/protocol. |  |
| `services[].vlan_id` | `string` | `yes` | `yes` | `hivemind` | VLAN where the service is considered to live. |  |
