...
| `services[].asset_id` | `string` | `yes` | `yes` | `ledger` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Firefly III` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `ledger-tcp80` | Stable identifier for the service; often includes port/protocol. |  |
