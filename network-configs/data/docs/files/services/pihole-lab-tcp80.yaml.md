# services/pihole-lab-tcp80.yaml
## Purpose
...
| `services[].asset_id` | `string` | `yes` | `yes` | `pihole-lab` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Pihole (Homelab)` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `pihole-lab-tcp80` | Stable identifier for the service; often includes port/protocol. |  |
