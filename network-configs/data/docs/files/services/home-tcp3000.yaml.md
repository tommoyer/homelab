...
| `services[].asset_id` | `string` | `yes` | `yes` | `home` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Homepage` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `home-tcp3000` | Stable identifier for the service; often includes port/protocol. |  |
