# services/pihole-dmz-tcp80.yaml
## Purpose
...
| `services[].asset_id` | `string` | `yes` | `yes` | `pihole-dmz` | Asset where this service runs. |  |
...
| `services[].name` | `string` | `yes` | `yes` | `Pihole (DMZ)` | Human-friendly service name. |  |
...
| `services[].service_id` | `string` | `yes` | `yes` | `pihole-dmz-tcp80` | Stable identifier for the service; often includes port/protocol. |  |
