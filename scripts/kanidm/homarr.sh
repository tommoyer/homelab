...
kanidm system oauth2 create homarr Homarr https://homarr.ts.moyer.wtf
kanidm system oauth2 add-redirect-url homarr https://homarr.ts.moyer.wtf/api/auth/callback/oidc
