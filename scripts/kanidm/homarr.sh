...
kanidm system oauth2 create homarr Homarr https://homarr.priv.moyer.wtf
kanidm system oauth2 add-redirect-url homarr https://homarr.priv.moyer.wtf/api/auth/callback/oidc
kanidm system oauth2 update-scope-map homarr homarr_users openid groups email profile
kanidm system oauth2 update-scope-map homarr homarr_admins openid groups email profile
